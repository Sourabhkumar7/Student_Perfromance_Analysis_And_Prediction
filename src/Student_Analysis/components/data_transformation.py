...
class DataTransformation:
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            level=["bachelor's degree", 'some college', "master's degree",
            ...
            cat_pipeline=Pipeline(
                ...
                ('ordinalencoder',OrdinalEncoder(handle_unknown='use_encoded_value', unknown_value=-1,categories=[genders,race,level,lunch,course])),
                ('scaler',StandardScaler())
                ]
    ...
    def initialize_data_transformation(self,train_path,test_path):
        try:
            ...
            input_feature_train_df = train_df.drop("Total_score",axis=1)
            target_feature_train_df=train_df[target_column_name]
            
            
            input_feature_test_df=test_df.drop("Total_score",axis=1)
